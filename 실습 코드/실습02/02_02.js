...
// 1
// const PrintAll = function (name) {
//   console.log(users.name)
// }

// users.forEach(PrintAll)
users.forEach((user) => console.log(user.name))

// 2
// const MarriedFilter = function (name) {
//   return users.isMarried === true
// }

// const married = users.filter(MarriedFilter)
// console.log(married)
